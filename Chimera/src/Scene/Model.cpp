...
namespace Chimera
{
    ...
    void Model::UploadToGPU(const ImportedScene& importedScene)
    {
        ...
        CH_CORE_INFO("Model: Uploading to GPU ({0} vertices, {1} indices)...", m_VertexCount, m_IndexCount);
        ...
        // 1. Create Staging and GPU Buffers
        ...
        // 3. Build Acceleration Structures if supported
        ...
        CH_CORE_INFO("Model: GPU Upload and AS build finished.");
    }
