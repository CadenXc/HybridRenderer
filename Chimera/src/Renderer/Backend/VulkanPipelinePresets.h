...
inline const VkVertexInputBindingDescription
    DEFAULT_VERTEX_BINDING_DESCRIPTION = Vertex::getBindingDescription();
...
inline const std::array<VkVertexInputAttributeDescription, 3>
    IMGUI_VERTEX_ATTRIBUTE_DESCRIPTIONS{
...
inline const VkPipelineVertexInputStateCreateInfo VERTEX_INPUT_STATE_DEFAULT{
    ...
    .vertexAttributeDescriptionCount =
        static_cast<uint32_t>(DEFAULT_VERTEX_ATTRIBUTE_DESCRIPTIONS.size()),
    .pVertexAttributeDescriptions =
        DEFAULT_VERTEX_ATTRIBUTE_DESCRIPTIONS.data()};
inline const VkPipelineVertexInputStateCreateInfo VERTEX_INPUT_STATE_IMGUI{
    ...
    .vertexAttributeDescriptionCount =
        static_cast<uint32_t>(IMGUI_VERTEX_ATTRIBUTE_DESCRIPTIONS.size()),
...
inline const VkPipelineRasterizationStateCreateInfo
    RASTERIZATION_STATE_CULL_CLOCKWISE = RASTERIZATION_STATE_DEFAULT;

inline const VkPipelineRasterizationStateCreateInfo
    RASTERIZATION_STATE_CULL_COUNTER_CLOCKWISE{
        .sType = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO,
        .polygonMode = VK_POLYGON_MODE_FILL,
...
inline const VkPipelineColorBlendAttachmentState
    COLOR_BLEND_ATTACHMENT_STATE_OFF{
