...
namespace VulkanUtils {
	...
	GraphicsPipeline CreateGraphicsPipeline(std::shared_ptr<VulkanContext> context, ResourceManager &resource_manager, 
		...
		case RasterizationState::CullClockwise:
			pipeline_info.pRasterizationState = &RASTERIZATION_STATE_CULL_CLOCKWISE; break;
		case RasterizationState::CullCounterClockwise:
			pipeline_info.pRasterizationState = &RASTERIZATION_STATE_CULL_COUNTER_CLOCKWISE; break;
