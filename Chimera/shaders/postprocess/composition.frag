...
void main() 
{
    ...
    float roughness = material.r; // Use raw roughness from G-Buffer (it was squared there)
    float metallic = material.g;
    float gBufferAO = material.b;
    ...
    // Note: EvalPbr already includes Cosine term internally in this version
